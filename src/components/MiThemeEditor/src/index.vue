        ...
        <div class="theme-content">
            <div>
                ...
                <input
                    ...
                    @change="updateTheme('primary-color', primaryColor)"
                />
            </div>
            <div>
                ...
                <input
                    ...
                    id="text-color"
                    v-model="textColor"
                    @change="updateTheme('text-color', textColor)"
                />
            </div>
            <div>
                ...
                <input
                    ...
                    @change="updateTheme('background-color', backgroundColor)"
                />
            </div>
            <!-- 暗黑模式切换按钮 -->
            <div class="dark-mode-toggle" @click="toggleDarkMode">
                <i
                    ...
                    :class="{ 'slide-right': isDarkMode }"
                ></i>
                <i
                    class="iconfont icon-night"
                    :class="{ 'fade-in': isDarkMode }"
                ></i>
            </div>
        </div>
    </div>
