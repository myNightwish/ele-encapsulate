...
const cityOptions = computed(() =>
    selectedCity.value?.children ? selectedCity.value.children : []
);
...
const areaOptions = computed(() =>
    selectedCityArea.value?.children ? selectedCityArea.value.children : []
);
...
const emitCity = () => {
    emits('chooseCity', {
        ...
        area: {
            code: area.value,
            name: selectedCityArea.value?.children.find(
